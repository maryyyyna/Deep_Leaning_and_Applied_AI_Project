...
## Dataset
The dataset used is the **Identification of Languages and Dialects of Italy (ITDI)** from [VarDial 2022](https://sites.google.com/view/vardial-2022/shared-tasks#h.x0q0staz3tdr), which provides a comprehensive collection of text samples across multiple Italian dialects using Wikipedia. Specifically, this project focuses on the Neapolitan dialect.
...
## Repository Strcture
 - `data`: the folder containing the dataset and related files.
 - `fine_tuned_LLM_model`: the folder containing the Fine-Tuned model and its configuration.
 - `Data_Analysis.ipynb`: the jupyter notebook used for Exploratory Data Analysis (EDA).
